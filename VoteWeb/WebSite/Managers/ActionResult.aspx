<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ActionResult.aspx.cs" Inherits="VoteWeb.WebSite.Managers.ActionResult" %>
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal" runat="server">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" placeholder="性别" id="mysex" runat="server" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-3 col-sm-8">
                                    ...
                                    <asp:LinkButton ID="Exit" class="btn btn-sm btn-white" runat="server" PostBackUrl="~/WebSite/Managers/User.aspx">返回</asp:LinkButton>
                                </div>
                            </div>
                        </form>
                    </div>
