<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VLogDetail.aspx.cs" Inherits="VoteWeb.WebSite.Students.VLogDetail" %>
...
<body>
     <form id="form1" runat="server">
          ...
          <a type="" href="VLog.aspx"><input type="button" class="btn btn-warning btn-circle" style="width:60px;height:auto"  value="Back" /></a>
