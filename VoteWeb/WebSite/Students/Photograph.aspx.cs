    ...
    public partial class Photograph : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
                ...
                string sql = string.Format(@" declare @tmp table(
                                                ...
                                                with a as ( select * from WorksList vl where Type='摄影作品' )
        ...
        protected void Vote_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (count > 0)
                {
                    ...
                    Response.Write("<script>alert('取消投票成功！');window.location.replace('Photograph.aspx');</script>");
                }
                else
                {
                    //投票
                    ...
                    Response.Write("<script>alert('投票成功！');window.location.replace('Photograph.aspx');</script>");
                }
