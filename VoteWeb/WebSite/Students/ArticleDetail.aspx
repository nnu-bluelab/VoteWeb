<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ArticleDetail.aspx.cs" Inherits="VoteWeb.WebSite.Students.ArtitleDetail" %>
...
<body>
     <form id="form1" runat="server">
          ...
          <a type="" href="Articles.aspx"><input type="button" style="width:60px;height:auto" class="btn btn-warning btn-circle " value="Back" /></a>
