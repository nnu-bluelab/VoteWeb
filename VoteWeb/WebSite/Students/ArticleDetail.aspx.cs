...
{
    public partial class ArtitleDetail : System.Web.UI.Page
    {
        ...
        protected void Comment_Click(object sender, EventArgs e)
        {
            ...
            if (result != 0)
            {
                string re = string.Format("<script>alert('评论成功！');window.location.replace('ArticleDetail.aspx?id={0}');</script>", id);
                Response.Write(re);
            }
            else
            {
